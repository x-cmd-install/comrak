...
[![x-cmd/install — comrak Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/comrak.svg?lang=zh)](https://x-cmd.com/install/comrak)
...
合计: **45,653** 行代码（覆盖前 5 种语言、共 **103** 个文件）。
...
- **上游仓库**: <https://github.com/kivikakk/comrak>
- **官网**: <https://comrak.ee>
- **许可证**: NOASSERTION
...
- **Star**: 1,709 · **Fork**: 194 · **开放 issue**: 266 · **贡献者**: 90

## 累计统计

- **发布数**: 93 · **已合并 PR**: 480 · **开放 PR**: 4 · **已关闭 issue**: 256 · **开放 issue**: 10 · **提交数**: 2226

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-26 | 1 | 12 | 1 | 1 | 1 | 21 |
| last60d | 2026-07-27 | 1 | 13 | 1 | 1 | 1 | 22 |
| 90d | 2026-06-27 | 3 | 27 | 2 | 2 | 1 | 79 |
| last180d | 2026-03-29 | 4 | 42 | 3 | 5 | 1 | 102 |
| 360d | 2025-09-30 | 13 | 170 | 4 | 26 | 4 | 450 |
| last720d | 2024-10-05 | 30 | 248 | 4 | 77 | 8 | 949 |
...
comrak 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `comrak` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/comrak.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T04:47:21Z._
