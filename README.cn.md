...
合计: **45,645** 行代码（覆盖前 5 种语言、共 **104** 个文件）。
...
- **Star**: 1,696 · **Fork**: 192 · **开放 issue**: 266 · **贡献者**: 89
...
在 [repology.org](https://repology.org/project/comrak) 上共有 **47** 个发行版报告此项目。**9** 个 ✅ 已是最新上游版本，**36** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260910.yml` · 2026-09-10T21:31:41Z._
